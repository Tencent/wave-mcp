...
def _stage_basic(tmp: str, a: str, b: str, expect_t: int) -> None:
    print("== correctness on a classic pass/fail pair ==")
...
def _stage_params(a: str, b: str, expect_t: int) -> None:
...
def _stage_edges(tmp: str, b: str) -> None:
    print("== edge cases ==")
    # missing file
    r_err = None
    try:
...
def _stage_mcp_wrapper(a: str, b: str) -> None:
    print("== MCP tool wrapper ==")
...
def main() -> int:
    ...
    _stage_basic(tmp, a, b, expect_t)
    _stage_params(a, b, expect_t)
    _stage_edges(tmp, b)
    _stage_mcp_wrapper(a, b)

...
def main() -> int:
    ...
    d.call("open_wave_view", {
        ...
        "signals": [
            {"path": "fsm_stuck_tb.clk",             "group": "时钟"},
            {"path": "fsm_stuck_tb.rst_n",           "group": "时钟"},
            {"path": "fsm_stuck_tb.rd_en",           "group": "握手信号",
             "color": "yellow"},
            {"path": "fsm_stuck_tb.req",             "group": "握手信号",
             "color": "red"},
            {"path": "fsm_stuck_tb.ack",             "group": "握手信号",
             "color": "green"},
            {"path": "fsm_stuck_tb.dut.state",       "group": "状态机",
             "color": "purple", "format": "signed"},
            {"path": "fsm_stuck_tb.rd_count",        "group": "状态指示",
             "format": "dec"},
        ],

...
def main() -> int:
    ...
    r = d.call("open_wave_view", {
        ...
        "signals": [
            {"path": "xprop_tb.clk",               "group": "clock_reset"},
            {"path": "xprop_tb.rst_n",             "group": "clock_reset"},
            {"path": "xprop_tb.start",             "group": "control_path",
             "color": "yellow"},
            {"path": "xprop_tb.dut.fsm_state",     "group": "control_path",
             "color": "purple", "format": "signed"},
            {"path": "xprop_tb.dut.byte_cnt",      "group": "datapath",
             "color": "red", "format": "bin"},
            {"path": "xprop_tb.din",               "group": "datapath",
             "format": "hex"},
            {"path": "xprop_tb.data_out",          "group": "datapath",
             "color": "red", "format": "hex"},
            {"path": "xprop_tb.done",              "group": "control_path"},
        ],

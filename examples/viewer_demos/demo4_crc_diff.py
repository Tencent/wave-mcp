...
def main() -> int:
    ...
    d.call("open_wave_view", {
        ...
        "labels": ["pass", "fail"],
        "signals": [
            {"path": "crc_diff_tb.clk",            "group": "clock",
             "source": "a"},
            {"path": "crc_diff_tb.valid",          "group": "stimulus",
             "source": "a", "color": "yellow"},
            {"path": "crc_diff_tb.data",           "group": "stimulus",
             "source": "a", "format": "bin"},
            {"path": "crc_diff_tb.eop",            "group": "stimulus",
             "source": "a"},
            {"path": "crc_diff_tb.dut.crc",        "group": "crc_divergence",
             "source": "b", "color": "red", "format": "bin"},
            {"path": "crc_diff_tb.crc_residue",    "group": "crc_divergence",
             "source": "b", "color": "red", "format": "bin"},
            {"path": "crc_diff_tb.crc_err",        "group": "crc_result",
             "source": "b", "color": "red"},
        ],

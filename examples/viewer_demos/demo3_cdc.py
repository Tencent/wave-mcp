...
def main() -> int:
    ...
    d.call("open_wave_view", {
        ...
        "signals": [
            {"path": "cdc_tb.clk_fast",           "group": "时钟",
             "color": "blue"},
            {"path": "cdc_tb.clk_slow",           "group": "时钟",
             "color": "purple"},
            {"path": "cdc_tb.rst_n",              "group": "时钟"},
            {"path": "cdc_tb.trigger",            "group": "快时钟域",
             "color": "yellow"},
            {"path": "cdc_tb.dut.pulse_fast",     "group": "快时钟域",
             "color": "orange"},
            {"path": "cdc_tb.pulse_seen",         "group": "慢时钟域",
             "color": "green"},

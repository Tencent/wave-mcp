...
Packaging removes upstream service workers and sample waveforms. Exact
source archives, dependency notices and build evidence must accompany the
assets under redistribution/. The upstream source for the pinned ref is:
